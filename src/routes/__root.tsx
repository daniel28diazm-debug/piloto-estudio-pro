...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "CIAAC Pilot — Examen teórico Piloto Comercial México" },
      { property: "og:description", content: "Estudia con IA: biblioteca, flashcards, simulador y tutor para el examen CIAAC." },
